              ...
              <div className="col-lg-3 col-md-3">
                <ul className="list-unstyled clear-margins">
                  <li className="widget-container-fluid widget_nav_menu">
                    ...
                    <ul>
                    <li style={{ textAlign: "left"  }}><a href="http://www.leadthecompetition.in/GK/booksandauthors/latest-books-in-news.html" style={{color:'#18906f'}}><i className="fa fa-angle-double-right" ></i>  Latest Books and Authors</a></li>
                      <li style={{ textAlign: "left" }}><a href="http://www.mygpscexam.com/2015/06/best-general-knowledge-books-for-all.html" style={{color:'#18906f'}}><i className="fa fa-angle-double-right"></i>  Best General Knowledge books</a></li>
                      <li style={{ textAlign: "left" }}><a href="https://www.infibeam.com/Books-entrance-exams/" style={{color:'#18906f'}}><i className="fa fa-angle-double-right"></i>  Books for Competitive Exams</a></li>
                ...
                <ul className="list-unstyled clear-margins">
                  ...
                  <li className="widget-container-fluid widget_recent_news">
                    ...
                    <div className="footerp">
                      ...
                      <p style={{ textAlign: "left" }}><b style={{color:'rgb(31, 30, 88)'}}>Email id:</b> <a style={{color:'#18906f'}} href="mailto:lims@mindtree.com">lims@mindtree.com</a></p>
